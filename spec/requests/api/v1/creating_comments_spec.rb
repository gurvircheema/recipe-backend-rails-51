...
RSpec.describe 'Creating comments' do
  ...
  describe 'POST /api/v1/comments' do
    context 'with valid body and attributes' do
      before { post "/api/v1/recipes/#{recipe.id}/comments", params: {user_id: user.id, body: 'New comment'}.to_json, headers: headers }
    ...
    context 'invalid body' do
      before { post "/api/v1/recipes/#{recipe.id}/comments", params: {user_id: user.id, body: ''}.to_json, headers: headers }
